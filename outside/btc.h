...
//TBD
uint32_t unsigned_txn_to_signed_txn(const unsigned_txn * const unsigned_txn_ptr, txn_metadata *txn_metadata_ptr, const char *mnemonic, const char *passphrase, signed_txn *signed_txn_ptr);

void signed_txn_to_byte_array(signed_txn *signed_txn_ptr, uint8_t *generated_signed_txn_byte_array);

void convert_hex_dump_to_byte_array(uint8_t *btc_unsigned_txn_byte_array, uint8_t *hex_dump);
